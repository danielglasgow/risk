...
/**
 * This class handles the visual appearance of the risk game board.
 */
public class Board { // make board a JPanel not frame...
    ...
    public void updateBackground(BoardState boardState) {
        ...
        for (Territory territory : boardState.getTerritories()) {
            newBackGround = new TextOverlay(newBackGround.getImage(), territory,
                    boardState.getArmies(territory), boardState.getPlayer(territory));
        }
